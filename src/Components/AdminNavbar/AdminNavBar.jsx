...
<div className="container-menu_Admin">
	<div className="cont-menu_Admin">
		<nav >
		<NavLink className= 'navBar__navLink' to='/admon'>Inicio</NavLink>
		<NavLink className= 'navBar__navLink' to='/admonCatalogo'>Catalogo</NavLink>
		<NavLink className= 'navBar__navLink' to='/pedidos'>Pedidos</NavLink>
		<NavLink className= 'navBar__navLink' to='/facturas'>Facturas</NavLink>
		</nav>
